    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-sky-50 to-white">
      ...
      <section className="relative flex flex-col items-center justify-center px-4 py-24 md:py-32 lg:py-40">
        ...
        <div className="text-center space-y-4">
          <h2 className="text-xl md:text-2xl font-light tracking-wider text-sky-600">Welcome to</h2>
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight text-sky-700">
            The Brand Destination
          </h1>
          <div className="pt-2">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tighter text-sky-800">H R Apparel</h1>
          </div>
          <div className="pt-6">
            <Button className="rounded-full px-8 py-6 text-base bg-sky-500 hover:bg-sky-600">
      ...
      <section className="w-full py-16 md:py-24">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-sky-700">Our Brands</h2>
            <p className="max-w-[700px] text-sky-600 md:text-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              ...
              <Link
                ...
                className="group relative overflow-hidden rounded-2xl border bg-white transition-all hover:shadow-lg hover:shadow-sky-100"
              >
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-10 lg:grid-cols-2">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-sky-700">Get in Touch</h2>
              <p className="text-sky-600 md:text-xl">
                We'd love to hear from you. Fill out the form and we'll get back to you as soon as possible.
              </p>
              <div className="space-y-2">
                <h3 className="text-xl font-medium text-sky-700">Contact Information</h3>
                <p className="text-sky-600">123 Fashion Avenue, Style District</p>
                <p className="text-sky-600">contact@hrapparel.com</p>
              ...
              <div className="grid gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Textarea
                    ...
                    className="min-h-[150px] rounded-xl border-sky-200 focus:border-sky-400"
                  />
                </div>
                <Button className="w-full rounded-xl bg-sky-500 hover:bg-sky-600">Send Message</Button>
              </div>
            </div>
          </div>
        </div>
