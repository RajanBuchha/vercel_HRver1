    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white">
      ...
      <div className="relative h-[300px] md:h-[400px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-sky-900/30 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">{brandData.name}</h1>
            <p className="text-lg md:text-xl max-w-2xl mx-auto px-4">{brandData.description}</p>
          </div>
        </div>
      </div>
      ...
      <div className="container px-4 py-8 md:py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            <h2 className="text-2xl font-bold text-sky-700">{brandData.name} Products</h2>
            <p className="text-sky-600">{brandData.productCount} products available</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Tabs defaultValue="grid" className="w-[200px]">
              <TabsList className="rounded-full">
                <TabsTrigger value="grid" className="rounded-full data-[state=active]:bg-sky-100">
                  <Grid3X3 className="h-4 w-4" />
                </TabsTrigger>
                <TabsTrigger value="list" className="rounded-full data-[state=active]:bg-sky-100">
